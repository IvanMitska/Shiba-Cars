          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-4 bg-gray-800 rounded-lg">
                ...
                <span className="text-orange-400 font-semibold">Зависит от района</span>
              </div>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="text-center bg-gray-800 rounded-lg p-6">
                <div className="text-4xl font-bold text-orange-400 mb-2">150 км</div>
                <div className="text-gray-300">в сутки включено</div>
              </div>
              
              <div className="flex justify-between items-center p-4 bg-gray-800 rounded-lg">
                <span className="text-gray-300">Дополнительный км</span>
                <span className="text-orange-400 font-semibold">2 THB</span>
              </div>
